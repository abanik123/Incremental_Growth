...
write.csv(combined_samples, file = "Big_m2_samples_vb.csv", row.names = FALSE)

pdf(file = "Big_mp_m2_vb.pdf")
...
MCMCtrace(samples,pdf = T,open_pdf = F,filename = "Big_m2_vb", ind = TRUE,
          Rhat = FALSE, n.eff = FALSE)

write.csv(s, file = "Big_m2_sum_vb.csv")
...
write.csv(f, file = "Big_m2_length_VB.csv")
