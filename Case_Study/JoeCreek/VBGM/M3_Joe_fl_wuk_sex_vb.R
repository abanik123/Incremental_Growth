...
write.csv(combined_samples, file = "Joe_m3_samples_vb.csv", row.names = FALSE)

pdf(file = "Joe_mp_m3_vb.pdf")
...
MCMCtrace(samples,pdf = T,open_pdf = F,filename = "Joe_m3_vb", ind = TRUE,
          Rhat = FALSE, n.eff = FALSE)
write.csv(s, file = "Joe_m3_sum_vb.csv")
...
write.csv(f, file = "Joe_m3_length_VB.csv")
